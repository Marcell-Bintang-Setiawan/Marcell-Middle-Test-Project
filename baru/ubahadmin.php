...
//ambil data di URL
$id = $_GET["id"];
// mengambid data admin berdasarkan id
$adm = query("SELECT * FROM film WHERE id = $id")[0];
...
<body>
            ...
            <div class="container">
                <div class="row text-center mt-3">
                    <div class="col">
                        <h2 class="text-dark">Ubah Data Admin</h2>
                    </div>
                </div>
                    ...
                    <div class="col-md-7">
                        ...
                        <form name="stay-touch" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nid" id="nid" class="form-control" required value="<?= $adm["nid"] ?>">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="email" id="email" class="form-control" required value="<?= $adm["email"] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="telepon" class="form-label text-dark"> <strong> Nomor Telepon </strong></label>
                                <input type="text" name="telepon" id="telepon" class="form-control" required value="<?= $adm["telepon"] ?>">
                            </div>
